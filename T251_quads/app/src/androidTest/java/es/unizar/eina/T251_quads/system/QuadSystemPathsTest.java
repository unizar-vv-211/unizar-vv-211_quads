...
public class QuadSystemPathsTest {
    ...
    public void camino1CreacionQuadConCancelacionTest() {
        ...
        rellenarYGuardarQuad("NIA8974", "Monoplaza", "45", "Prueba de creación con cancelación previa"); // T10: Guardar Quad
    ...
    public void camino2EdicionYBorradoMultipleQuadsTest() {
        ...
        // --- PRE-CONDICIÓN: Inyectamos datos para poder borrarlos ---
        pulsarCrear();
