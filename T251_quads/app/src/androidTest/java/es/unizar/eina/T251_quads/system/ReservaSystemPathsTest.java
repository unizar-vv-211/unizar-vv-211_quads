...
public class ReservaSystemPathsTest {
     ...
     * Secuencia: T11 -> T18 -> T20 -> T18 -> T21 -> T19 -> T20 -> T19 -> T21 -> T13 -> T12 -> T11 -> T12 -> T1
     */
    @Test
    public void camino4CicloDeVidaCompletoReservaTest() {
        // --- PRE-CONDICIÓN: Asegurar Quad disponible ---
        irAQuads();
        pulsarCrear();
        ...
        try { Thread.sleep(500); } catch (Exception e) {} // Pausa UI
        rellenarYGuardarReserva("Raul Samper", "600123456", "15-05-2030", "18-05-2030", "1", "RES1111"); // T21: Guardar Reserva
        ...
        rellenarYGuardarReserva("Raul y Samuel", "600123456", "15-05-2030", "22-05-2030", "2", null); // T21: Guardar cambios
     ...
     * Secuencia base: T11 -> T14 -> T15 -> T16 -> T17 -> T14 -> T13 -> T15 -> T18 -> T21 -> T12
     */
    @Test
    public void camino5GestionDeFiltrosReservasTest() {
        ...
        // --- INYECCIÓN (T17 -> T18 -> T21): Preparamos datos para eliminar en pasadas ---
        ...
        pulsarCrear();               // T18: Abrir formulario creación
        try { Thread.sleep(500); } catch (Exception e) {}
        rellenarYGuardarReserva("Serrano", "987654321", "13-05-2031", "14-05-2031", "1", "RES2222"); // T21: Guardar Reserva
